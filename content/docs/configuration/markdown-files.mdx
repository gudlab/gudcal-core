...
description: How the blog and docs content system works.
---
...
This file configures Contentlayer to look for Markdown files in the specified directories (`content/blog`, `content/docs`, `content/pages`). It also defines the different document types you use in your project along with the fields associated with each document type.
...
Here's the list of all frontmatters available for each part:
...
---
title: timchosen
avatar: /_static/avatars/timchosen.png
twitter: timchosen
---
```
...
description: The story behind open-source scheduling infrastructure.
...
---
title: API Reference
description: REST API documentation for GudCal.
---
```
...
---
title: Privacy
description: The Privacy Policy for GudCal.
---
```
