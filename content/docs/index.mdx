...
GudCal is **source-available scheduling infrastructure** for the AI agent era. It is a self-hostable Calendly alternative with an MCP server, team scheduling, and smart availability management.

## Key Features

- **Agent-First** — 21 MCP tools + full REST API let AI agents manage your entire scheduling operation autonomously
...
- **Source-Available** — BSL 1.1. Self-host for your own org; do not offer a competing hosted Calendly. Hosted extras (analytics, custom domains) stay on Cloud. MCP source ships in the repo; **hosted** MCP on gudcal.com is Team.
...
- [MCP Server](/docs/mcp) — AI agent integration guide (21 tools for full autonomous operation)
